...
import 'package:travelmate/screens/trip_plan/calender.dart';
import 'package:travelmate/screens/trip_plan/trip_plan_repository.dart';
import 'package:travelmate/widgets/text.dart';

ValueNotifier<List<ModelDestination>> selectedDestinationIdsforTripPlanning =
    ValueNotifier<List<ModelDestination>>([]);
ValueNotifier<List<ModelDestination>> selectedDestinationIdsforTripPlannings =
    ValueNotifier<List<ModelDestination>>([]);
...
class ScreenTripPlanState extends State<ScreenTripPlan> {
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/images/image trip.avif'),
                          fit: BoxFit.cover)),
                ),
                Padding(
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ValueListenableBuilder<List<ModelDestination>>(
                        valueListenable: selectedDestinationIdsforTripPlannings,
                        builder:
                            (context, List<ModelDestination> value, child) {
  ...
  Future<bool> validation(context) async {
    if (_tripNameController.text.isEmpty) {
      ...
      await TripPlanRepository()
          .addTrip(tripPlanModel, selectedDestinationIdsforTripPlannings.value);
      setState(() {
